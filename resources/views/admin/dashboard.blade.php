...
<body class="relative min-h-screen">
    ...
    <div class="absolute inset-0">
        <img src="/images/foto-pejabat.jpeg" class="w-full h-full object-cover scale-100 blur-[1px] brightness-100">
    </div>

    <!-- OVERLAY -->
    <div class="absolute inset-0 bg-linear-to-br from-blue-900/20 via-blue-800/20 to-blue-900/20"></div>
